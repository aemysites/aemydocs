...
5. Review this file, and make any required changes directly to the branch created by AEMY.
5. Finally, you can click the green **Merge pull request** button and confirm the merge. This will also close the associated issue.
