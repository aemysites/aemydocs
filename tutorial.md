...
6. If the file looks good, you can click the green **Merge pull request** button and confirm the merge. This will also close the associated issue.
...
2. **Optimize**: Proceed with fine-tuning the styles of individual blocks.
3. **Expand**: Try migrating different types of sites.
